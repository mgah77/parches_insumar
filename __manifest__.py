...

{
    ...
    'author' : 'M.Gah',
    'website': '',
    'depends': ['account','stock','base','sale','sale_stock','sale_management','l10n_cl_fe','product','contacts','utm','hr','crm','l10n_cl_stock_picking','spreadsheet_dashboard','Insumar_Crones','mail'],
    'data': [
            "security/groups.xml",
